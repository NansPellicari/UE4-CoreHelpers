...
-   Fork the repository from [NansPellicari/UE4-CoreHelpers](https://github.com/NansPellicari/UE4-CoreHelpers) !
...
-   Submit a pull request to `develop` branch of `NansPellicari/UE4-CoreHelpers` repository !
