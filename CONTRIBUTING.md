...
-   Fork the repository from [NansPellicari/UE4-NansCoreHelpers](https://github.com/NansPellicari/UE4-NansCoreHelpers) !
...
-   Submit a pull request to `develop` branch of `NansPellicari/UE4-NansCoreHelpers` repository !
